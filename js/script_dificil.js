(function () {
    ...
    //variável contadora de acertos. ao chegar em 12 o jogo termina
    var matches = 0;
        ...
        if (flippedCards.length < 2) {
            ...
            if (flippedCards.length === 2) {
                ...
                if (flippedCards[0].childNodes[3].id === flippedCards[1].childNodes[3].id) {
                    ...
                    //verifica se o contador de acertos chegou a 8. OBS: feita uma alteração para 12 acertos
                    if (matches >= 12) {
                        //caso haja 12 acertos, chama a função que finaliza o jogo
                        gameOver();
                    }
